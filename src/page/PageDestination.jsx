    ...
    return (
        <section className='page-destination-main'>
            <div className='page-destination-content-main overflow-hidden mx-3'>
                ...
                <div className="destination-cards-main relative max-w-lg md:max-w-2xl lg:max-w-7xl mx-auto py-12 grid grid-rows-1 grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6
                        ...
                        <div className="card relative rounded-2xl text-[var(--text-dark)] w-auto overflow-hidden border border-black/14 group" key={i}>
                            ...
                            <div className="card-details mx-3 space-y-4.5 my-4">
                                ...
                                <div className="card-pricing flex flex-row justify-between items-center mx-1 pt-4 border-t border-dashed border-[var(--bg-secondary)]">
                                    ...
                                    <Link to='/tour_details' className='font-semibold text-sm lg:text-[16px]'>
